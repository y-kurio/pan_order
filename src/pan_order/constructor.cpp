...
OrderClass::OrderClass()
{
	...
	sub_pan_angle_ =nh_.subscribe("/robot_4/pan/command",1,&OrderClass::__pan_angle_callback,this);
	sub_tilt_angle_ =nh_.subscribe("/robot_4/tilt/command",1,&OrderClass::__tilt_angle_callback,this);
	__setLaunchParam();
}
OrderClass::~OrderClass()
{
